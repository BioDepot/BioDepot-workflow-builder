...
class WebSocketTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.server = self._get_websockserver(daemon=True, ssl_only=False)
    ...
    def _mock_select_keyboardinterrupt(self, rlist, wlist, xlist, timeout=None):
    ...
    def test_decode_hybi(self):
        ...
        self.assertRaises(Exception, soc.decode_hybi, "a" * 128, base64=True)
    ...
    def test_start_server_Exception(self):
        ...
        self.stubs.Set(
            websocket.WebSocketServer, "daemonize", lambda *args, **kwargs: None
        )
    ...
    def test_start_server_systemexit(self):
        ...
        soc = self._get_websockserver(
            daemon=True, ssl_only=0, idle_timeout=1, verbose=True
        )
        self.assertEqual(None, soc.start_server())
    ...
    def test_WSRequestHandle_do_GET_nofile(self):
        ...
        with tempfile.NamedTemporaryFile() as test_file:
            ...
            soc.headers = {"upgrade": ""}
            self.stubs.Set(
                SimpleHTTPRequestHandler, "send_response", lambda *args: None
            )
            soc.do_GET()
