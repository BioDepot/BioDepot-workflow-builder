...
class FlaskAppWrapper(object):
    ...
    def __init__(self, hostname, hostport, run_command_fnc, status_fnc, log_fnc):
        ...
        self.add_endpoint(endpoint='/log', endpoint_name='log', handler=self.log, methods=['GET'])
    ...
    def log(self):
        ...
        if container_name is None:
            raise RuntimeError("get parameter 'container_name' missing.")
        return self.__log_fnc__(container_name=container_name)
