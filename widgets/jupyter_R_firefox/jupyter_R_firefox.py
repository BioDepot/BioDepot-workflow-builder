...
class OWjupyter_R_firefox(OWBwBWidget):
    name = "jupyter_R_firefox"
    description = "Base installation of Jupyter"
    category = "Jupyter"
    priority = 104
    icon = "/widgets/jupyter_R_firefox/icon/jupyter-R-firefox.png"
    want_main_area = False
    docker_image_name = "biodepot/jupyter"
    docker_image_tag = "5.6.0__ubuntu-18.04__R-3.4.4__firefox-61.0.1__081318"
    ...
    def __init__(self):
        ...
        with open("/widgets/jupyter_R_firefox/jupyter_R_firefox.json") as f:
