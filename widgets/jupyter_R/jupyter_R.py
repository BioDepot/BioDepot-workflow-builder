...
class OWjupyter_R(OWBwBWidget):
    name = "jupyter_R"
    description = "Base installation of Jupyter"
    category = "Jupyter"
    priority = 103
    icon = "/widgets/jupyter_R/icon/jupyter-R.png"
    want_main_area = False
    docker_image_name = "biodepot/jupyter"
    docker_image_tag = "5.6.0__ubuntu-18.04__R-3.4.4__081318"
    ...
    def __init__(self):
        ...
        with open("/widgets/jupyter_R/jupyter_R.json") as f:
