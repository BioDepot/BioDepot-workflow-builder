...
class TestDiscovery(unittest.TestCase):
    ...
    def test_process_module(self):
        disc = self.discovery_class()
        disc.process_category_package("Orange.widgets.data")
        disc.process_widget_module("Orange.widgets.classify.ownaivebayes")

    def test_process_loader(self):
        disc = self.discovery_class()

        def callable(discovery):
            desc = CategoryDescription(name="Data", qualified_name="Data")
    ...
    def test_process_iter(self):
        disc = self.discovery_class()
        cat_desc = CategoryDescription.from_package("Orange.widgets.data")
        wid_desc = widget_descriptions_from_package("Orange.widgets.data")
