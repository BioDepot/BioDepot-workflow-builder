...
INSTALL_REQUIRES = sorted(
    set(
        ...
        for file in (
            os.path.join(os.path.dirname(__file__), file) for file in requirements
        )
...
EXTRAS_REQUIRE = {':python_version<="3.4"': ["typing"]}

ENTRY_POINTS = {
    "orange.canvas.help": ("html-index = Orange.widgets:WIDGET_HELP_PATH",),
    "gui_scripts": ("orange-canvas = Orange.canvas.__main__:main",),
}
...
PACKAGE_DATA = {
    ...
    "Orange.widgets.data.tests": ["origin1/*.tab", "origin2/*.tab"],
