...
from Orange.widgets.visualize.utils.tree.rules import ContinuousRule, IntervalRule
...
class TestRules(unittest.TestCase):
    ...
    def test_merging_interval_rule_with_smaller_continuous_rule(self):
        ...
        rule1 = IntervalRule(
            "Rule", ContinuousRule("Rule", True, 1), ContinuousRule("Rule", False, 2)
        )
        rule2 = ContinuousRule("Rule", False, 2)
        new_rule = rule1.merge_with(rule2)
        self.assertIsInstance(new_rule, IntervalRule)
    ...
    def test_merging_interval_rule_with_larger_lt_continuous_rule(self):
        ...
        rule1 = IntervalRule(
            "Rule", ContinuousRule("Rule", True, 0), ContinuousRule("Rule", False, 3)
        )
    ...
    def test_merging_interval_rules_with_smaller_lt_component(self):
        ...
        rule2 = IntervalRule(
            "Rule", ContinuousRule("Rule", True, 0), ContinuousRule("Rule", False, 2)
        )
        new_rule = rule1.merge_with(rule2)
        self.assertEqual(new_rule.left_rule.value, 1)
        self.assertEqual(new_rule.right_rule.value, 2)
    ...
    def test_merging_interval_rules_with_larger_lt_component(self):
        ...
        rule1 = IntervalRule(
            "Rule", ContinuousRule("Rule", True, 0), ContinuousRule("Rule", False, 4)
        )
        rule2 = IntervalRule(
            "Rule", ContinuousRule("Rule", True, 1), ContinuousRule("Rule", False, 4)
        )
        new_rule = rule1.merge_with(rule2)
        self.assertEqual(new_rule.left_rule.value, 1)
    ...
    def test_merging_interval_rules_generally(self):
        ...
        rule2 = IntervalRule(
            "Rule", ContinuousRule("Rule", True, 2), ContinuousRule("Rule", False, 6)
        )
        new_rule = rule1.merge_with(rule2)
    ...
    def test_merge_commutativity_on_interval_rules(self):
        ...
        new_rule1 = rule1.merge_with(rule2)
        new_rule2 = rule2.merge_with(rule1)
        self.assertEqual(new_rule1.left_rule.value, new_rule2.left_rule.value)
        self.assertEqual(new_rule1.right_rule.value, new_rule2.right_rule.value)
