...
class TestOWDataSets(WidgetTest):
    @patch(
        "Orange.widgets.data.owdatasets.OWDataSets.list_remote",
        Mock(side_effect=requests.exceptions.ConnectionError),
    )
    @patch(
        "Orange.widgets.data.owdatasets.OWDataSets.list_local", Mock(return_value={})
    )
    ...
    @patch(
        "Orange.widgets.data.owdatasets.OWDataSets.list_local",
    ...
    @patch(
        "Orange.widgets.data.owdatasets.OWDataSets.list_local",
        Mock(return_value={("core", "foo.tab"): {}, ("core", "bar.tab"): {}}),
    )
    @patch("Orange.widgets.data.owdatasets.log", Mock())
    ...
    @patch(
        "Orange.widgets.data.owdatasets.OWDataSets.list_local",
        Mock(return_value={("dir1", "dir2", "foo.tab"): {}, ("bar.tab",): {}}),
    )
    @patch("Orange.widgets.data.owdatasets.log", Mock())
