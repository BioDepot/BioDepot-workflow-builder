...
class OWSGD(OWBaseLearner):
    ...
    description = (
        "Minimize an objective function using a stochastic "
    ...
    def _add_regularization_to_layout(self):
        ...
        self.penalty_combo = gui.comboBox(
            ...
            items=list(zip(*self.penalties))[0],
            orientation=Qt.Horizontal,
    ...
    def _add_learning_params_to_layout(self):
        ...
        self.tol_spin = gui.spin(
            ...
            spinType=float,
            controlWidth=80,
            label="Tolerance (stopping criterion): ",
            checked="tol_enabled",
            alignment=Qt.AlignRight,
            callback=self.settings_changed,
        )
        ...
        self.random_seed_spin = gui.spin(
            ...
            0,
            MAXINT,
            label="Fixed seed for random shuffling: ",
            controlWidth=80,
            alignment=Qt.AlignRight,
            callback=self.settings_changed,
