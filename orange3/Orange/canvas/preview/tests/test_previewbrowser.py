...
svg1 = pkg_resources.resource_string("Orange.canvas", "icons/default-category.svg")

svg2 = pkg_resources.resource_string("Orange.canvas", "icons/default-widget.svg")


def construct_test_preview_model():
    items = [
        ("Name1", "A preview item 1", svg1.decode("ascii"), "~/bla"),
        ("Name2", "A preview item 2" + "long text" * 5, svg2.decode("ascii"), "~/item"),
    ]
