...
class TestPerfectDomainContextHandler(TestCase):
    ...
    def test_encode_domain_simple(self):
        ...
        self.assertEqual(
            attrs, (("c1", Continuous), ("d1", Discrete), ("d2", Discrete))
        )
    ...
    def test_encode_domain_match_values(self):
        ...
        self.assertEqual(
            attrs, (("c1", Continuous), ("d1", list("abc")), ("d2", list("def")))
        )
    ...
    def test_match_simple(self):
        ...
        self.assertEqual(
            self.handler.match(context, *self.args), self.handler.PERFECT_MATCH
        )
    ...
    def test_match_values(self):
        ...
        self.handler.match_values = self.handler.MATCH_VALUES_ALL
        self.assertEqual(
            self.handler.match(context, *self.args_match_all),
