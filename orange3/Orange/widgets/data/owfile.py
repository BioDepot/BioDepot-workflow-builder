...
class OWFile(widget.OWWidget, RecentPathsWComboMixin):
    ...
    description = (
        "Read data from an input file or network "
    ...
    def __init__(self):
        ...
        self.sheet_combo = gui.comboBox(
            None, self, "xls_sheet", callback=self.select_sheet, sendSelectedValue=True
        )
        ...
        if self.source == self.LOCAL_FILE:
            ...
            if (
                ...
                and os.path.getsize(last_path) > self.SIZE_LIMIT
            ):
    ...
    def _describe(self, table):
        ...
        text += "<p>{} instance(s), {} feature(s), {} meta attribute(s)".format(
