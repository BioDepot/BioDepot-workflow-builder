...
class TestOWSGD(WidgetTest, WidgetLearnerTestMixin):
    def setUp(self):
        ...
        self.parameters = [
            ...
            ParameterMapping(
                "epsilon", self.widget.cls_epsilon_spin, problem_type="classification"
            ),
            ...
            ParameterMapping(
                "epsilon", self.widget.reg_epsilon_spin, problem_type="regression"
            ),
            # Shared params
            ParameterMapping(
                "penalty",
                self.widget.penalty_combo,
            ...
            ParameterMapping(
                "learning_rate",
                self.widget.learning_rate_combo,
