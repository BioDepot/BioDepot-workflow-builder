...
def importWorkflow(owsFile):
    ...
    os.system('rm -rf /biodepot/{}/icon'.format(projectTitlePath))
    os.system('cp -r {}/widgets/{}/icon  /biodepot/{} '.format(workflowDir,projectTitlePath,projectTitlePath))
    os.system('cp  {}/widgets/{}/__init__.py  /biodepot/{}/.'.format(workflowDir,projectTitlePath,projectTitlePath))
    if changedSetup:
